...
function usdtsol_link($params)
{
    ...
    $paygatedotto_usdtsol_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_usdtsol_response_minimum = file_get_contents('https://api.paygate.to/crypto/sol/usdt/info.php');
$paygatedottocryptogateway_usdtsol_conversion_resp_minimum = json_decode($paygatedottocryptogateway_usdtsol_response_minimum, true);
if ($paygatedottocryptogateway_usdtsol_conversion_resp_minimum && isset($paygatedottocryptogateway_usdtsol_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_usdtsol_final_total_minimum = $paygatedottocryptogateway_usdtsol_conversion_resp_minimum['minimum'];
    if ($paygatedotto_usdtsol_amount_to_send < $paygatedottocryptogateway_usdtsol_final_total_minimum) {
...
'und_tol' => $paygatedotto_usdtsol_underpaidTolerance,
