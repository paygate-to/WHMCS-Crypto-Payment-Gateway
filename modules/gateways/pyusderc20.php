...
function pyusderc20_link($params)
{
    ...
    $paygatedotto_pyusderc20_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_pyusderc20_response_minimum = file_get_contents('https://api.paygate.to/crypto/erc20/pyusd/info.php');
$paygatedottocryptogateway_pyusderc20_conversion_resp_minimum = json_decode($paygatedottocryptogateway_pyusderc20_response_minimum, true);
if ($paygatedottocryptogateway_pyusderc20_conversion_resp_minimum && isset($paygatedottocryptogateway_pyusderc20_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_pyusderc20_final_total_minimum = $paygatedottocryptogateway_pyusderc20_conversion_resp_minimum['minimum'];
    if ($paygatedotto_pyusderc20_amount_to_send < $paygatedottocryptogateway_pyusderc20_final_total_minimum) {
...
'und_tol' => $paygatedotto_pyusderc20_underpaidTolerance,
