...
function arbarbitrum_MetaData()
{
    return array(
        'DisplayName' => 'arbarbitrum',
        'DisableLocalCreditCardInput' => true,
    );
}

function arbarbitrum_config()
{
    return array(
        'FriendlyName' => array(
            'Type' => 'System',
        ...
        'description' => array(
            ...
            'Rows' => '3',
            'Cols' => '25',
            'Default' => 'Pay using crypto Arbitrum arbitrum.',
        ...
        'wallet_address' => array(
            'FriendlyName' => 'Arbitrum arbitrum Wallet Address',
            'Type' => 'text',
            'Description' => 'Insert your arbitrum-arb Wallet address.',
        ),
    );
}

function arbarbitrum_link($params)
{
    $walletAddress = $params['wallet_address'];
    $paygatedotto_arbarbitrum_underpaidTolerance = $params['underpaid_tolerance'];
...
'und_tol' => $paygatedotto_arbarbitrum_underpaidTolerance,
...
function arbarbitrum_activate()
{
    ...
    return array('status' => 'success', 'description' => 'arbarbitrum gateway activated successfully.');
}

function arbarbitrum_deactivate()
{
    // You can customize deactivation logic if needed
    return array('status' => 'success', 'description' => 'arbarbitrum gateway deactivated successfully.');
}

function arbarbitrum_upgrade($vars)
{
    // You can customize upgrade logic if needed
}

function arbarbitrum_output($vars)
{
    // Output additional information if needed
}

function arbarbitrum_error($vars)
{
