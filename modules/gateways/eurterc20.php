...
function eurterc20_link($params)
{
    ...
    $paygatedotto_eurterc20_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_eurterc20_response_minimum = file_get_contents('https://api.paygate.to/crypto/erc20/eurt/info.php');
$paygatedottocryptogateway_eurterc20_conversion_resp_minimum = json_decode($paygatedottocryptogateway_eurterc20_response_minimum, true);
if ($paygatedottocryptogateway_eurterc20_conversion_resp_minimum && isset($paygatedottocryptogateway_eurterc20_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_eurterc20_final_total_minimum = $paygatedottocryptogateway_eurterc20_conversion_resp_minimum['minimum'];
    if ($paygatedotto_eurterc20_amount_to_send < $paygatedottocryptogateway_eurterc20_final_total_minimum) {
...
'und_tol' => $paygatedotto_eurterc20_underpaidTolerance,
