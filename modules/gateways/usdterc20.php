...
function usdterc20_link($params)
{
    ...
    $paygatedotto_usdterc20_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_usdterc20_response_minimum = file_get_contents('https://api.paygate.to/crypto/erc20/usdt/info.php');
$paygatedottocryptogateway_usdterc20_conversion_resp_minimum = json_decode($paygatedottocryptogateway_usdterc20_response_minimum, true);
if ($paygatedottocryptogateway_usdterc20_conversion_resp_minimum && isset($paygatedottocryptogateway_usdterc20_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_usdterc20_final_total_minimum = $paygatedottocryptogateway_usdterc20_conversion_resp_minimum['minimum'];
    if ($paygatedotto_usdterc20_amount_to_send < $paygatedottocryptogateway_usdterc20_final_total_minimum) {
...
'und_tol' => $paygatedotto_usdterc20_underpaidTolerance,
