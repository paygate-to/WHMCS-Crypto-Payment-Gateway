...
function eth_link($params)
{
    ...
    $paygatedotto_eth_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_eth_response_minimum = file_get_contents('https://api.paygate.to/crypto/eth/info.php');
$paygatedottocryptogateway_eth_conversion_resp_minimum = json_decode($paygatedottocryptogateway_eth_response_minimum, true);
if ($paygatedottocryptogateway_eth_conversion_resp_minimum && isset($paygatedottocryptogateway_eth_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_eth_final_total_minimum = $paygatedottocryptogateway_eth_conversion_resp_minimum['minimum'];
    if ($paygatedotto_eth_amount_to_send < $paygatedottocryptogateway_eth_final_total_minimum) {
...
'und_tol' => $paygatedotto_eth_underpaidTolerance,
'coin_to_send' => 'eth'
));
