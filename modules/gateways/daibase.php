...
function daibase_link($params)
{
    ...
    $paygatedotto_daibase_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_daibase_response_minimum = file_get_contents('https://api.paygate.to/crypto/base/dai/info.php');
$paygatedottocryptogateway_daibase_conversion_resp_minimum = json_decode($paygatedottocryptogateway_daibase_response_minimum, true);
if ($paygatedottocryptogateway_daibase_conversion_resp_minimum && isset($paygatedottocryptogateway_daibase_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_daibase_final_total_minimum = $paygatedottocryptogateway_daibase_conversion_resp_minimum['minimum'];
    if ($paygatedotto_daibase_amount_to_send < $paygatedottocryptogateway_daibase_final_total_minimum) {
...
'und_tol' => $paygatedotto_daibase_underpaidTolerance,
