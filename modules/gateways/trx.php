...
function trx_link($params)
{
    ...
    $paygatedotto_trx_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_trx_response_minimum = file_get_contents('https://api.paygate.to/crypto/trx/info.php');
$paygatedottocryptogateway_trx_conversion_resp_minimum = json_decode($paygatedottocryptogateway_trx_response_minimum, true);
if ($paygatedottocryptogateway_trx_conversion_resp_minimum && isset($paygatedottocryptogateway_trx_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_trx_final_total_minimum = $paygatedottocryptogateway_trx_conversion_resp_minimum['minimum'];
    if ($paygatedotto_trx_amount_to_send < $paygatedottocryptogateway_trx_final_total_minimum) {
...
'und_tol' => $paygatedotto_trx_underpaidTolerance,
'coin_to_send' => 'trx'
));
