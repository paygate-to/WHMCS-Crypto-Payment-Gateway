...
function linkarbitrum_link($params)
{
    ...
    $paygatedotto_linkarbitrum_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_linkarbitrum_response_minimum = file_get_contents('https://api.paygate.to/crypto/arbitrum/link/info.php');
$paygatedottocryptogateway_linkarbitrum_conversion_resp_minimum = json_decode($paygatedottocryptogateway_linkarbitrum_response_minimum, true);
if ($paygatedottocryptogateway_linkarbitrum_conversion_resp_minimum && isset($paygatedottocryptogateway_linkarbitrum_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_linkarbitrum_final_total_minimum = $paygatedottocryptogateway_linkarbitrum_conversion_resp_minimum['minimum'];
    if ($paygatedotto_linkarbitrum_amount_to_send < $paygatedottocryptogateway_linkarbitrum_final_total_minimum) {
...
'und_tol' => $paygatedotto_linkarbitrum_underpaidTolerance,
