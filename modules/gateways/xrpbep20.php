...
function xrpbep20_link($params)
{
    ...
    $paygatedotto_xrpbep20_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_xrpbep20_response_minimum = file_get_contents('https://api.paygate.to/crypto/bep20/xrp/info.php');
$paygatedottocryptogateway_xrpbep20_conversion_resp_minimum = json_decode($paygatedottocryptogateway_xrpbep20_response_minimum, true);
if ($paygatedottocryptogateway_xrpbep20_conversion_resp_minimum && isset($paygatedottocryptogateway_xrpbep20_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_xrpbep20_final_total_minimum = $paygatedottocryptogateway_xrpbep20_conversion_resp_minimum['minimum'];
    if ($paygatedotto_xrpbep20_amount_to_send < $paygatedottocryptogateway_xrpbep20_final_total_minimum) {
...
'und_tol' => $paygatedotto_xrpbep20_underpaidTolerance,
