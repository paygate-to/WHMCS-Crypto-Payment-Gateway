...
function mkrerc20_MetaData()
{
    return array(
        'DisplayName' => 'mkrerc20',
        'DisableLocalCreditCardInput' => true,
    );
}

function mkrerc20_config()
{
    return array(
        'FriendlyName' => array(
            'Type' => 'System',
        ...
        'description' => array(
            ...
            'Rows' => '3',
            'Cols' => '25',
            'Default' => 'Pay using crypto Maker erc20.',
        ...
        'wallet_address' => array(
            'FriendlyName' => 'Maker erc20 Wallet Address',
            'Type' => 'text',
            'Description' => 'Insert your erc20-mkr Wallet address.',
        ),
    );
}

function mkrerc20_link($params)
{
    $walletAddress = $params['wallet_address'];
    $paygatedotto_mkrerc20_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_mkrerc20_response_minimum = file_get_contents('https://api.paygate.to/crypto/erc20/mkr/info.php');
$paygatedottocryptogateway_mkrerc20_conversion_resp_minimum = json_decode($paygatedottocryptogateway_mkrerc20_response_minimum, true);
if ($paygatedottocryptogateway_mkrerc20_conversion_resp_minimum && isset($paygatedottocryptogateway_mkrerc20_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_mkrerc20_final_total_minimum = $paygatedottocryptogateway_mkrerc20_conversion_resp_minimum['minimum'];
    if ($paygatedotto_mkrerc20_amount_to_send < $paygatedottocryptogateway_mkrerc20_final_total_minimum) {
...
'und_tol' => $paygatedotto_mkrerc20_underpaidTolerance,
...
function mkrerc20_activate()
{
    ...
    return array('status' => 'success', 'description' => 'mkrerc20 gateway activated successfully.');
}

function mkrerc20_deactivate()
{
    // You can customize deactivation logic if needed
    return array('status' => 'success', 'description' => 'mkrerc20 gateway deactivated successfully.');
}

function mkrerc20_upgrade($vars)
{
    // You can customize upgrade logic if needed
}

function mkrerc20_output($vars)
{
    // Output additional information if needed
}

function mkrerc20_error($vars)
{
