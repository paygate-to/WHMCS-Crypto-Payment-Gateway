...
function usdcbep20_link($params)
{
    ...
    $paygatedotto_usdcbep20_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_usdcbep20_response_minimum = file_get_contents('https://api.paygate.to/crypto/bep20/usdc/info.php');
$paygatedottocryptogateway_usdcbep20_conversion_resp_minimum = json_decode($paygatedottocryptogateway_usdcbep20_response_minimum, true);
if ($paygatedottocryptogateway_usdcbep20_conversion_resp_minimum && isset($paygatedottocryptogateway_usdcbep20_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_usdcbep20_final_total_minimum = $paygatedottocryptogateway_usdcbep20_conversion_resp_minimum['minimum'];
    if ($paygatedotto_usdcbep20_amount_to_send < $paygatedottocryptogateway_usdcbep20_final_total_minimum) {
...
'und_tol' => $paygatedotto_usdcbep20_underpaidTolerance,
