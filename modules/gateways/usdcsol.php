...
function usdcsol_link($params)
{
    ...
    $paygatedotto_usdcsol_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_usdcsol_response_minimum = file_get_contents('https://api.paygate.to/crypto/sol/usdc/info.php');
$paygatedottocryptogateway_usdcsol_conversion_resp_minimum = json_decode($paygatedottocryptogateway_usdcsol_response_minimum, true);
if ($paygatedottocryptogateway_usdcsol_conversion_resp_minimum && isset($paygatedottocryptogateway_usdcsol_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_usdcsol_final_total_minimum = $paygatedottocryptogateway_usdcsol_conversion_resp_minimum['minimum'];
    if ($paygatedotto_usdcsol_amount_to_send < $paygatedottocryptogateway_usdcsol_final_total_minimum) {
...
'und_tol' => $paygatedotto_usdcsol_underpaidTolerance,
