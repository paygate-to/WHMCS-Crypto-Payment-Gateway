...
function phptbep20_link($params)
{
    ...
    $paygatedotto_phptbep20_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_phptbep20_response_minimum = file_get_contents('https://api.paygate.to/crypto/bep20/phpt/info.php');
$paygatedottocryptogateway_phptbep20_conversion_resp_minimum = json_decode($paygatedottocryptogateway_phptbep20_response_minimum, true);
if ($paygatedottocryptogateway_phptbep20_conversion_resp_minimum && isset($paygatedottocryptogateway_phptbep20_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_phptbep20_final_total_minimum = $paygatedottocryptogateway_phptbep20_conversion_resp_minimum['minimum'];
    if ($paygatedotto_phptbep20_amount_to_send < $paygatedottocryptogateway_phptbep20_final_total_minimum) {
...
'und_tol' => $paygatedotto_phptbep20_underpaidTolerance,
