...
function wetheavaxc_link($params)
{
    ...
    $paygatedotto_wetheavaxc_underpaidTolerance = $params['underpaid_tolerance'];
...
$paygatedottocryptogateway_wetheavaxc_response_minimum = file_get_contents('https://api.paygate.to/crypto/avax-c/weth.e/info.php');
$paygatedottocryptogateway_wetheavaxc_conversion_resp_minimum = json_decode($paygatedottocryptogateway_wetheavaxc_response_minimum, true);
if ($paygatedottocryptogateway_wetheavaxc_conversion_resp_minimum && isset($paygatedottocryptogateway_wetheavaxc_conversion_resp_minimum['minimum'])) {
    $paygatedottocryptogateway_wetheavaxc_final_total_minimum = $paygatedottocryptogateway_wetheavaxc_conversion_resp_minimum['minimum'];
    if ($paygatedotto_wetheavaxc_amount_to_send < $paygatedottocryptogateway_wetheavaxc_final_total_minimum) {
...
'und_tol' => $paygatedotto_wetheavaxc_underpaidTolerance,
